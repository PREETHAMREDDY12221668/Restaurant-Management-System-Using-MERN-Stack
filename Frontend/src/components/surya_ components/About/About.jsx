  ...
  return (
    <div>
      ...
      <div className="imgcards">
        <div>
          <h1 className="child">OUR CRISPY HERITAGE</h1>
        </div>
        <div>
          <h1 className="child">ALL ABOUT CHICKEN</h1>
        </div>
        <div>
          <h1 className="child">BEING FAST FOOD</h1>
        </div>
        <div>
          <h1 className="child">JOIN THE COLONEL'S CREW</h1>
        </div>
      </div>

      <div className="journey">
        <div className="journeytext">
          <h1>Journey of fried chicken, through the ages</h1>
          <p>
            ...
            and spices scratched out on the back of his kitchen <br />
            door, that continues to be followed across 145 countries, with more
            than 800,000 team members breading and freshly preparing bucket
            after bucket of our signature Hot & <br />
            Crispy chicken. The Colonel’s Secret Recipe continues to be as
            guarded; and our commitment towards Food, People and Planet remains
            as steadfast. With a new KFC restaurant <br />
            opening every 6 hours, we power on to serve the World’s Tastiest
            Chicken!
          </p>
        </div>
